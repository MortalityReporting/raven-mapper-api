...
COPY --from=builder /usr/src/raven_mapper_api/target/raven-import-and-submit-api-0.0.3-SNAPSHOT.war /usr/local/tomcat/webapps/raven_import_and_submit_api.war
