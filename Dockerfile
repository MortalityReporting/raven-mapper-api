...
COPY --from=builder /usr/src/raven_import_and_submit_api/target/raven-import-and-submit-api-0.0.4-SNAPSHOT.war /usr/local/tomcat/webapps/raven-import-and-submit-api.war
